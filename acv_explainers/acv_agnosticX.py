...
class ACXplainer:
    ...
    def compute_ddp_rf(self, X, y, data, y_data, S, min_node_size=5, t=20):
        """
         Estimate the Same Decision Probability (SDP) of a set of samples X given subset S using the consistent estimator
         (Projected Forest + Quantile Regression), see Paper [ref]
    ...
    def compute_ddp_rule(self, X, y, data, y_data, S, min_node_size=5, t=20):
        """
         Estimate the local rule-based explanations of a set of samples X given Sufficient Explanations S using
         the consistent estimator (Projected Forest + Quantile Regression), see Paper [ref]. For each observation x, all
         observations that falls in the rule of x has the same SDP as x.
    ...
    def compute_ddp_weights(self, X, y, data, y_data, S, min_node_size=5, t=20, pi_level=0.95,
                             verbose=False, algo2=False, rdm_size=20):
        """
         Estimate the maximal rule-based explanations of a set of samples X given Sufficient Explanations S using the consistent estimator
         (Projected Forest + Quantile Regression), see Paper [ref]. For each instance x, all
    ...
    def compute_cdp_cond_weights(self, X, y, down, up, data, y_data, S, cond, min_node_size=5, t=20, pi_level=0.95,
                             verbose=False, algo2=False, rdm_size=20):
        """
    ...
    def compute_cdp_rf(self, X, y, down, up, data, y_data, S, min_node_size=5, t=20):
        """
         Estimate the Same Decision Probability (SDP) of a set of samples X given subset S using the consistent estimator
         (Projected Forest + Quantile Regression), see Paper [ref]
        ...
        ddp = cyext_acv.compute_cdp_rf(X, y, down, up, data, y_data, S, self.ACXplainer.features, self.ACXplainer.thresholds,
                                       self.ACXplainer.children_left,
                                       self.ACXplainer.children_right, self.ACXplainer.max_depth, min_node_size,
                                       self.classifier, t)
        return ddp

    def compute_cdp_rule(self, X, y, down, up, data, y_data, S, min_node_size=5, t=20):
        """
         Estimate the local rule-based explanations of a set of samples X given Sufficient Explanations S using
         the consistent estimator (Projected Forest + Quantile Regression), see Paper [ref]. For each observation x, all
         observations that falls in the rule of x has the same SDP as x.
    ...
    def compute_cdp_weights(self, X, y, down, up, data, y_data, S, min_node_size=5, t=20, pi_level=0.95,
                             verbose=False, algo2=False, rdm_size=20):
        """
         Estimate the maximal rule-based explanations of a set of samples X given Sufficient Explanations S using the consistent estimator
         (Projected Forest + Quantile Regression), see Paper [ref]. For each instance x, all
    ...
    def compute_ddp_cond_weights(self, X, y, data, y_data, S, cond, min_node_size=5, t=20, pi_level=0.95,
                             verbose=False, algo2=False, rdm_size=20):
        """
         Compute P(Y \neq y | X_{\bar{S}} in rule_{\bar{S}}, X_S=x_S)
        Args:
    ...
    def importance_ddp_rf(self, X, y, data, y_data, min_node_size=5, t=20,
                          C=[[]], pi_level=0.9, minimal=1, stop=True):
        """
         Estimate the Minimal Sufficient Explanations and the Global sdp importance of a set of samples X using the
         consistent estimator (Projected Forest + Quantile Regression), see Paper [ref].
    ...
    def importance_cdp_rf(self, X, y, down, up, data, y_data, min_node_size=5, t=20,
                          C=[[]], pi_level=0.9, minimal=1, stop=True):
        """
         Estimate the Minimal Sufficient Explanations and the Global sdp importance of a set of samples X using the
         consistent estimator (Projected Forest + Quantile Regression), see Paper [ref].
        ...
        return cyext_acv.global_cdp_rf(X, y, down, up, data, y_data, self.ACXplainer.features, self.ACXplainer.thresholds,
                                       self.ACXplainer.children_left,
                                       self.ACXplainer.children_right, self.ACXplainer.max_depth, min_node_size,
                                       self.classifier, t, C,
                                       pi_level, minimal, stop, search_space[:10])
    ...
    def sufficient_cxpl_rf(self, X, y, data, y_data, min_node_size=5, t=20,
                           C=[[]], pi_level=0.9, minimal=1, stop=True):
        ...
        return cyext_acv.sufficient_cxpl_rf(X, y, data, y_data, self.ACXplainer.features, self.ACXplainer.thresholds,
                                            self.ACXplainer.children_left,
                                            self.ACXplainer.children_right, self.ACXplainer.max_depth, min_node_size,
                                            self.classifier, t, C,
                                            pi_level, minimal, stop, search_space[:10])
    ...
    def compute_ddp_intv_weights(self, X, y, data, y_data, S, cond, min_node_size=5, t=20, pi_level=0.95,
                             verbose=False, algo2=False, rdm_size=20):
        """
    ...
    def compute_ddp_intv_same(self, X, y, data, y_data, S, cond, min_node_size=5, t=20, pi_level=0.95,
                             verbose=False, algo2=False, rdm_size=20):
        """
    ...
    def importance_ddp_intv(self, X, y, data, y_data, cond, min_node_size=5, t=20,
                          C=[[]], pi_level=0.9, minimal=1, stop=True):
        """
